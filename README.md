...
Personal macOS dotfiles: zsh (oh-my-zsh) + Neovim + tmux + OmniWM (AeroSpace kept as a fallback), symlinked into place via `install.sh`.
...
| [docs/neovim.md](docs/neovim.md) | Neovim customizations on top of kickstart.nvim, known quirks, commands |
...
| [docs/omniwm.md](docs/omniwm.md) | OmniWM tiling window manager (the one in daily use) |
| [docs/aerospace.md](docs/aerospace.md) | AeroSpace tiling window manager (kept as a fallback) |
